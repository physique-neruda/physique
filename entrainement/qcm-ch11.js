/* Genere par outils/construire.py — ne pas editer a la main.
   Chapitre 11 · Énergie transportée par la lumière
   Les QCM viennent de ch11_prerequis.tex et ch11_bilan.tex,
   les cartes de cartes/cartes-ch11.json. */
window.CHAPITRE = {
 "num": "11",
 ...
 "prerequis": [
  ...
  {
   "q": "Convertir 1 mm^2 en mètres carrés :",
   "choix": [
    "10⁻³ m^2",
    "10⁻⁶ m^2",
    "10⁻² m^2",
 ...
 "bilan": [
  ...
  {
   "q": "On veut 1800 W électriques avec des panneaux à 18 /cent sous E = 1000 W/m². La surface nécessaire vaut :",
   "choix": [
    "1,8 m^2",
    "10 m^2",
    "18 m^2",
